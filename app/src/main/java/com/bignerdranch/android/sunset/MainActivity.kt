...
class MainActivity : AppCompatActivity() {
    ...
    // track whether the sun is set or not
    ...
    private fun startSunriseAnimation() {
        ...
        // transition from sunset color back to blue sky
        ...
        val animatorSet = AnimatorSet()
        animatorSet
            // start with the sun rising, then change sky colors
            .play(heightAnimator)
            .with(daySkyAnimator)
